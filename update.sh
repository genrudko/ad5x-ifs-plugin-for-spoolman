...
PLUGIN_FILES="ifs_spoolman.py ifs_spoolman_runtime.py ifs_spoolman_writer.py ifs_spoolman_ui.py ifs_spoolman_local.py zmod-filaments.html zmod-filaments-live.js zmod-inventory-provider.js zmod-combined-inventory.js ui_v0_2.html ifs-spoolman-card.js ifs-spoolman-layout.js ifs-spoolman-dashboard.js ifs-spoolman-visibility.js ifs-spoolman-selection.js ifs-spoolman-controls.js"
