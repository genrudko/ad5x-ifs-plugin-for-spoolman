(() => {
  ...
  function colorVisual(single, multiple, direction) {
    ...
    const swatch = sequential || colors.length > 4
    ...
    return {
      colors,
      swatch,
      progress: smoothGradient(colors),
      count: colors.length,
      sequential
    };
  }
